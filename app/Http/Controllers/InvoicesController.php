...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $user = User::first();
        // Notification::send('p.abdullahanwar@gmail.com',new AddInvoice($invoice_id));

        $userSchema = User::where('id','!=',auth()->user()->id)->get();
        ...
        // $userSchema->notify(new AddInvoice($invoice_id));
        Notification::send($userSchema, new AddInvoiceNew($offerData));
