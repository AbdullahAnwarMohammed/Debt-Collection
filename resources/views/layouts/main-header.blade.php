								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a  class="badge badge-pill badge-warning mr-auto my-auto float-left" href="/ReadAll">قراءة الكل</a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">الاشعات : {{ auth()->user()->unreadNotifications()->count() }}</p>
									</div>
									<div class="main-notification-list Notification-scroll">

										@foreach ( auth()->user()->unreadNotifications as $data)

										<a class="d-flex p-3 border-bottom" href="/InvoicesDetails/{{ $data['data']['invoice_id'] }}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">تم اضافة فاتورة جديدة </h5>
