<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='home') }}">برنامج الفواتير</a>
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='home') }}">برنامج الفواتير</a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}">برنامج الفواتير</a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='index') }}">برنامج الفواتير</a>
			</div>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتيرالمدفوعة</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='customerReport') }}">تقرير العملاء</a></li>
